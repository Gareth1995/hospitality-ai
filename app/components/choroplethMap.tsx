...
// interface Review {
//   // Define your review object structure here
//   id: string;
//   content: string;
// }
...
//   // const handleMoveEnd = useCallback((position: { coordinates: number[]; zoom: number }) => {
//   //   setTimeout(() => {
...
//     // Ensure the position coordinates have exactly two numbers
//     setTimeout(() => {
